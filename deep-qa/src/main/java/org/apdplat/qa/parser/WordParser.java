...
public class WordParser {
	...
	public static void main(String[] args) {
		...
		System.out.println("二：" + parse);
		parse = parse("法克油fuck");
		System.out.println("三：" + parse);
		parse = parse("哈雷彗星的发现者是六小龄童和伦琴,专访微软亚洲研究院院长洪小文");
		System.out.println("四：" + parse);
		String str = "五：" + "《创业邦》杂志记者对微软亚洲研究院院长洪小文进行了专访。 《创业邦》：微软亚洲  研究院 ... 从研发的角度来说，研究院是一个战略性的部门。因为一家公司最后成功与   ...";
		parse = parse(str);
		System.out.println("六：" + parse);
